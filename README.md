...
## Description:
Space shooter was developed in 2017.  
...
## Warning:
Some assets have been removed, and others haven't been updated. This could result in a lot of errors!<br>
After trying to update the project to a newer unity version, I kinda broke TMpro. This means that the project doesn't have any text at all. *i'm not going to fix this*
